...
def test_history_and_outputs_accumulate() -> None:
    module = Leibovich2022MultispeciesEcoCompetitionDescrModel2212080001Model(integration_step=0.1, rng_seed=3)
...
def test_diversity_metrics_are_well_formed() -> None:
    module = Leibovich2022MultispeciesEcoCompetitionDescrModel2212080001Model(integration_step=0.1, rng_seed=4)
...
def test_visuals_contain_multi_point_trajectories() -> None:
    module = Leibovich2022MultispeciesEcoCompetitionDescrModel2212080001Model(integration_step=0.2, rng_seed=1)
...
def test_higher_immigration_supports_richness() -> None:
    low = Leibovich2022MultispeciesEcoCompetitionDescrModel2212080001Model(immigration_rate=0.05, rng_seed=2, integration_step=0.1)
    high = Leibovich2022MultispeciesEcoCompetitionDescrModel2212080001Model(immigration_rate=1.2, rng_seed=2, integration_step=0.1)
