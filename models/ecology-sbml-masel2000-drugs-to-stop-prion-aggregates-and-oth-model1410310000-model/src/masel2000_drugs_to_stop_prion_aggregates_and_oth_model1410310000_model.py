...
"""Auto-generated SBML BioModule wrapper for Masel2000 - Drugs to stop prion aggregates and other amyloids.

Source: biomodels_ebi:MODEL1410310000
Original: https://www.ebi.ac.uk/biomodels/MODEL1410310000
"""
...
class SbmlMasel2000DrugsToStopPrionAggregatesAndOtherAmyloids(biosim.BioModule):
    """BioModule wrapper for SBML model: Masel2000 - Drugs to stop prion aggregates and other amyloids."""

    def __init__(self, model_path: str = "data/MODEL1410310000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Masel2000DrugsToStopPrionAggregatesAndOthModel1410310000Model = SbmlMasel2000DrugsToStopPrionAggregatesAndOtherAmyloids
