...
"""Auto-generated SBML BioModule wrapper for NIK-dependent p100 processing into p52 with RelB binding and IkBd degradation, mass action, SBML 2v4.

Source: biomodels_ebi:BIOMD0000000871
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000871
"""
...
class SbmlNikDependentP100ProcessingIntoP52WithRelbBinding(biosim.BioModule):
    """BioModule wrapper for SBML model: NIK-dependent p100 processing into p52 with RelB binding and IkBd degradation, mass action, SBML 2v4."""

    def __init__(self, model_path: str = "data/BIOMD0000000871.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NikDependentP100ProcessingIntoP52WithRelbBiomd0000000871Model = SbmlNikDependentP100ProcessingIntoP52WithRelbBinding
