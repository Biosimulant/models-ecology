...
"""Auto-generated SBML BioModule wrapper for Weimann2004_CircadianOscillator.

Source: biomodels_ebi:BIOMD0000000170
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000170
"""
...
class SbmlWeimann2004Circadianoscillator(biosim.BioModule):
    """BioModule wrapper for SBML model: Weimann2004_CircadianOscillator."""

    def __init__(self, model_path: str = "data/BIOMD0000000170.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weimann2004CircadianoscillatorBiomd0000000170Model = SbmlWeimann2004Circadianoscillator
