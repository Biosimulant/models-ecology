...
"""Auto-generated SBML BioModule wrapper for Wodarz2003 - Immunological Memory.

Source: biomodels_ebi:BIOMD0000000684
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000684
"""
...
class SbmlWodarz2003ImmunologicalMemory(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2003 - Immunological Memory."""

    def __init__(self, model_path: str = "data/BIOMD0000000684.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2003ImmunologicalMemoryBiomd0000000684Model = SbmlWodarz2003ImmunologicalMemory
