...
"""Auto-generated SBML BioModule wrapper for Novak2001_FissionYeast_CellCycle.

Source: biomodels_ebi:BIOMD0000000111
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000111
"""
...
class SbmlNovak2001FissionyeastCellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Novak2001_FissionYeast_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000111.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Novak2001FissionyeastCellcycleBiomd0000000111Model = SbmlNovak2001FissionyeastCellcycle
