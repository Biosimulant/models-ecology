...
"""Auto-generated SBML BioModule wrapper for Rao2014 - Fatty acid beta-oxidation (reduced model).

Source: biomodels_ebi:BIOMD0000000835
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000835
"""
...
class SbmlRao2014FattyAcidBetaOxidationReducedModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Rao2014 - Fatty acid beta-oxidation (reduced model)."""

    def __init__(self, model_path: str = "data/BIOMD0000000835.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rao2014FattyAcidBetaOxidationReducedModelBiomd0000000835Model = SbmlRao2014FattyAcidBetaOxidationReducedModel
