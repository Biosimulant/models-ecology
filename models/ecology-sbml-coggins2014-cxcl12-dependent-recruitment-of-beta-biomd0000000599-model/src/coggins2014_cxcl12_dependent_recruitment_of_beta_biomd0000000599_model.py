...
"""Auto-generated SBML BioModule wrapper for Coggins2014 - CXCL12 dependent recruitment of beta arrestin.

Source: biomodels_ebi:BIOMD0000000599
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000599
"""
...
class SbmlCoggins2014Cxcl12DependentRecruitmentOfBetaArrestin(biosim.BioModule):
    """BioModule wrapper for SBML model: Coggins2014 - CXCL12 dependent recruitment of beta arrestin."""

    def __init__(self, model_path: str = "data/BIOMD0000000599.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Coggins2014Cxcl12DependentRecruitmentOfBetaBiomd0000000599Model = SbmlCoggins2014Cxcl12DependentRecruitmentOfBetaArrestin
