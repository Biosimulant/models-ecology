...
"""Auto-generated SBML BioModule wrapper for Hansen2019 - Seven species reduced model of blood coagulation.

Source: biomodels_ebi:MODEL1907180003
Original: https://www.ebi.ac.uk/biomodels/MODEL1907180003
"""
...
class SbmlHansen2019SevenSpeciesReducedModelOfBloodCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Hansen2019 - Seven species reduced model of blood coagulation."""

    def __init__(self, model_path: str = "data/MODEL1907180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hansen2019SevenSpeciesReducedModelOfBloodModel1907180003Model = SbmlHansen2019SevenSpeciesReducedModelOfBloodCoagulation
