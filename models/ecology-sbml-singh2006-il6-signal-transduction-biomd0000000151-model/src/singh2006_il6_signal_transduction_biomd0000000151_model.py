...
"""Auto-generated SBML BioModule wrapper for Singh2006_IL6_Signal_Transduction.

Source: biomodels_ebi:BIOMD0000000151
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000151
"""
...
class SbmlSingh2006Il6SignalTransduction(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2006_IL6_Signal_Transduction."""

    def __init__(self, model_path: str = "data/BIOMD0000000151.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2006Il6SignalTransductionBiomd0000000151Model = SbmlSingh2006Il6SignalTransduction
