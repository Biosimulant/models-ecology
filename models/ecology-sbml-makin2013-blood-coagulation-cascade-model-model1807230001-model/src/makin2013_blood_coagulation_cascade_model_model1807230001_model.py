...
"""Auto-generated SBML BioModule wrapper for Makin2013 - Blood coagulation cascade model.

Source: biomodels_ebi:MODEL1807230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1807230001
"""
...
class SbmlMakin2013BloodCoagulationCascadeModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Makin2013 - Blood coagulation cascade model."""

    def __init__(self, model_path: str = "data/MODEL1807230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Makin2013BloodCoagulationCascadeModelModel1807230001Model = SbmlMakin2013BloodCoagulationCascadeModel
