...
"""Auto-generated SBML BioModule wrapper for Venkatraman2011 - PLS-UPA behaviour in the presence of substrate competition_1_1_1_1.

Source: biomodels_ebi:BIOMD0000000630
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000630
"""
...
class SbmlVenkatraman2011PlsUpaBehaviourInThePresenceOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Venkatraman2011 - PLS-UPA behaviour in the presence of substrate competition_1_1_1_1."""

    def __init__(self, model_path: str = "data/BIOMD0000000630.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Venkatraman2011PlsUpaBehaviourInThePresencBiomd0000000630Model = SbmlVenkatraman2011PlsUpaBehaviourInThePresenceOf
