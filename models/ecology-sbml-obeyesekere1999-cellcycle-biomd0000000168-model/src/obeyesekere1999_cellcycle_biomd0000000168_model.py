...
"""Auto-generated SBML BioModule wrapper for Obeyesekere1999_CellCycle.

Source: biomodels_ebi:BIOMD0000000168
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000168
"""
...
class SbmlObeyesekere1999Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Obeyesekere1999_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000168.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Obeyesekere1999CellcycleBiomd0000000168Model = SbmlObeyesekere1999Cellcycle
