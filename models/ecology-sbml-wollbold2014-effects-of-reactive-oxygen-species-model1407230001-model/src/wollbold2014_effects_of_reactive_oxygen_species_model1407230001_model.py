...
"""Auto-generated SBML BioModule wrapper for Wollbold2014 - Effects of reactive oxygen species.

Source: biomodels_ebi:MODEL1407230001
Original: https://www.ebi.ac.uk/biomodels/MODEL1407230001
"""
...
class SbmlWollbold2014EffectsOfReactiveOxygenSpecies(biosim.BioModule):
    """BioModule wrapper for SBML model: Wollbold2014 - Effects of reactive oxygen species."""

    def __init__(self, model_path: str = "data/MODEL1407230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wollbold2014EffectsOfReactiveOxygenSpeciesModel1407230001Model = SbmlWollbold2014EffectsOfReactiveOxygenSpecies
