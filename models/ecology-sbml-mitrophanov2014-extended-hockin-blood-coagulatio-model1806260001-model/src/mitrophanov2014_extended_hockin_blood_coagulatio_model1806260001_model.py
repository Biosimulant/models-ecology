...
"""Auto-generated SBML BioModule wrapper for Mitrophanov2014 - Extended Hockin Blood Coagulation Model with additional fibrin-associated species.

Source: biomodels_ebi:MODEL1806260001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806260001
"""
...
class SbmlMitrophanov2014ExtendedHockinBloodCoagulationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitrophanov2014 - Extended Hockin Blood Coagulation Model with additional fibrin-associated species."""

    def __init__(self, model_path: str = "data/MODEL1806260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitrophanov2014ExtendedHockinBloodCoagulatioModel1806260001Model = SbmlMitrophanov2014ExtendedHockinBloodCoagulationModel
