...
"""Auto-generated SBML BioModule wrapper for Hansen2019 - Nine species reduced model of blood coagulation.

Source: biomodels_ebi:BIOMD0000000755
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000755
"""
...
class SbmlHansen2019NineSpeciesReducedModelOfBloodCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Hansen2019 - Nine species reduced model of blood coagulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000755.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hansen2019NineSpeciesReducedModelOfBloodCBiomd0000000755Model = SbmlHansen2019NineSpeciesReducedModelOfBloodCoagulation
