...
"""Auto-generated SBML BioModule wrapper for Mouse Iron Distribution - Adequate iron diet (tracer).

Source: biomodels_ebi:BIOMD0000000735
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000735
"""
...
class SbmlMouseIronDistributionAdequateIronDietTracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mouse Iron Distribution - Adequate iron diet (tracer)."""

    def __init__(self, model_path: str = "data/BIOMD0000000735.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MouseIronDistributionAdequateIronDietTraceBiomd0000000735Model = SbmlMouseIronDistributionAdequateIronDietTracer
