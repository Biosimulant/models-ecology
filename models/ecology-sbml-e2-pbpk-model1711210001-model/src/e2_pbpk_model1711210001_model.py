...
"""Auto-generated SBML BioModule wrapper for E2_PBPK.

Source: biomodels_ebi:MODEL1711210001
Original: https://www.ebi.ac.uk/biomodels/MODEL1711210001
"""
...
class SbmlE2Pbpk(biosim.BioModule):
    """BioModule wrapper for SBML model: E2_PBPK."""

    def __init__(self, model_path: str = "data/MODEL1711210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
E2PbpkModel1711210001Model = SbmlE2Pbpk
